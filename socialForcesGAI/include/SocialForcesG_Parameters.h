...
/*
 * SocialForcesG_Parameters.h
 *
 *  Created on: 2013-04-11
 *      Author: glenpb
 */

#ifndef SocialForcesG_PARAMETERS_H_
#define SocialForcesG_PARAMETERS_H_
...
inline std::ostream &operator<<(std::ostream & out, const SocialForcesGParameters & p)
...
#endif /* SocialForcesG_PARAMETERS_H_ */
