...
#define PERSONALSPACE 0.1 // Personal space added to PAM agent's radius
#define AGENT_REPULSION_IMPORTANCE 0.3 // in HiDAC
#define QUERY_RADIUS 3.0f // used for agent's visual field
...
#define T 0.5f // relaxation time for PAM agent goal force
#define W_FACTOR .8f // weight factor base to add individual evasive forces to compute total evasive force
#define RHO (_radius + PERSONALSPACE) // rho > radius (PAM Karamouzas et al. paper page 44 #4)
#define ANTICIPATION_TIME 4.f //anticipation time (PAM Karamouzas et al. paper page 44 #6)
#define EVASIVE_FORCE_MAGNITUDE_CONSTANT 1.f
#define DMID 4.f
#define DMIN RHO // rho = radius + personal
#define DMAX (ANTICIPATION_TIME*MAX_SPEED)
#define EPSILON 0.001f
#define PI 3.14159265358979323846f
#define INFTY 9e9f // a very large number immitating infinity
