...
//
// Extracted from SocialForcesAIModule.h located in socialForcesAI folder
// 

#ifndef __PredictiveAvoidance_AI_MODULE__
#define __PredictiveAvoidance_AI_MODULE__
...
class PredictiveAvoidanceAIModule : public SteerLib::ModuleInterface
{
public:
