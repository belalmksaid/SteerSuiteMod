...
namespace SteerLib {
	...
	{
	public:
		BoxObstacle(float xmin, float xmax, float ymin, float ymax, float zmin, float zmax, float traversalCost=1001.0f) : _bounds(xmin, xmax, ymin, ymax, zmin, zmax), _traversalCost(traversalCost)
		{
