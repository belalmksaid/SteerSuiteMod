...
*/	/// A pointer type used by the EngineInterface, points to a function that executes a custom command.
	...
	public:
		...
		/// Add room
		virtual void addRoom(SteerLib::Room* room) = 0;
		/// Add exit
		virtual void addExit(SteerLib::Exit* exit) = 0;
		/// Add room
		virtual void addEvacuationTarget(SteerLib::EvacuationTarget evacTarget) = 0;
		//@}
