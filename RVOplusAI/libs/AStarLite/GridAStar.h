...
#ifndef __GRID_ASTAR_H__
#define __GRID_ASTAR_H__
...
public:
	...
	bool canBeTraversed(unsigned int index) const { return (_spatialDatabase->getTraversalCost(index) < 1000); }

	//=================================================================================
	//=================================================================================
	GridEnvironment(SteerLib::GridDatabase2D * db) { _spatialDatabase = db; }
	...
	void getSuccessors(int nodeId, int lastNodeId, vector<Successor>& result) const
	{
		...
		// implement a right-hand type rule for cases where need to go around symmetric obstacles
	...
	bool isValidNodeId(int nodeId) const  { return nodeId >= 0 && nodeId < getNumberNodes(); }
